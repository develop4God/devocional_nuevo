...
void main() {
  group('Multi-Year Devotionals Integration Tests', () {
    ...
    group('Real User Behavior - Year Transition Scenarios', () {
      test(
        'User who read 2026 devotionals can still access 2025 devotionals',
        () async {
          ...
          expect(
            stats.readDevocionalIds.contains('devotional_2026_01_01'),
            true,
          );
          expect(
            stats.readDevocionalIds.contains('devotional_2026_01_02'),
            true,
          );
          ...
          expect(
            updatedStats.readDevocionalIds.contains('devotional_2025_12_31'),
            true,
          );
        },
      );
      ...
      test(
        'New user in 2026 gets devotionals from both 2025 and 2026',
        () async {
          ...
          expect(stats.totalDevocionalesRead, 2);
          expect(
            stats.readDevocionalIds.contains('devotional_2025_01_15'),
            true,
          );
          expect(
            stats.readDevocionalIds.contains('devotional_2026_01_15'),
            true,
          );
        },
      );
      ...
      test(
        ...
        () async {
          ...
          expect(
            stats.readDevocionalIds.contains('devotional_2025_12_30'),
            true,
          );
          expect(
            stats.readDevocionalIds.contains('devotional_2025_12_31'),
            true,
          );
          expect(
            stats.readDevocionalIds.contains('devotional_2026_01_01'),
    ...
    group('Edge Cases - Multi-Year Loading', () {
      test(
        'Handles devotionals with same date across different years',
        () async {
      ...
      test(
        'Handles devotionals with different versions across years',
        () async {
          final devocionales = <Devocional>[
            Devocional(
    ...
    group('Data Persistence - Multi-Year Scenarios', () {
      test('Read devotionals persist correctly across app restarts', () async {
        ...
        expect(
          stats2.readDevocionalIds.contains('devotional_2025_05_15'),
          true,
        );
        expect(
          stats2.readDevocionalIds.contains('devotional_2026_05_15'),
          true,
        );
      });

      test(
        'Mixed read and unread devotionals across years are tracked',
        () async {
          final statsService = SpiritualStatsService();
