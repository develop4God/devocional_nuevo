...
void main() {
  group('SpiritualStats Answered Prayers Feature', () {
    ...
    test('SpiritualStats merge handles zero answeredPrayersCount on one device',
        () {
      final deviceA = SpiritualStats(
        answeredPrayersCount: 15,
      );
    ...
    test('SpiritualStats merge with both devices having zero answered prayers',
        () {
      final deviceA = SpiritualStats(
        answeredPrayersCount: 0,
      );
