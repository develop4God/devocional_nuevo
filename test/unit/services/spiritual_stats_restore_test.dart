...
void main() {
  group('SpiritualStatsService.restoreStats() — Backup Format Handling', () {
    ...
    test(
      'should restore from FLAT backup format (no stats wrapper)',
      () async {
    ...
    test(
      'should restore from LEGACY wrapped format (stats key)',
      () async {
    ...
    test(
      'should handle read_dates even if stats are missing',
      () async {
    ...
    test(
      'should rethrow exceptions after logging',
      () async {
        final invalidData = {
    ...
    test(
      'should restore full backup with all fields populated',
      () async {
