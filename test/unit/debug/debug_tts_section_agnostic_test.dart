...
void main() {
  group('DebugTtsSection - Language Agnostic Tests', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(home: Scaffold(body: DebugTtsSection())),
        );
    ...
    testWidgets('Should dynamically load languages from VoiceDataRegistry', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: DebugTtsSection())),
      ...
      expect(
        VoiceDataRegistry.supportedLanguages.isNotEmpty,
        true,
        reason: 'VoiceDataRegistry should have at least one supported language',
      );
