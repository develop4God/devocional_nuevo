...
void main() {
  group('BibleVersionRegistry Tests', () {
    ...
    test('should get versions for Spanish language', () async {
      ...
      expect(versions.any((v) => v.name == 'Reina Valera 1960 (RVR1960)'), isTrue);
      expect(versions.any((v) => v.name == 'Nueva Versión Internacional (NVI)'), isTrue);
    ...
    test('should get versions for English language', () async {
      ...
      expect(versions.any((v) => v.name == 'New International Version (NIV)'), isTrue);
    ...
    test('should get versions for Portuguese language', () async {
      ...
      expect(versions, isNotEmpty);
      expect(versions.any((v) => v.name == 'Almeida Revista e Corrigida (ARC)'), isTrue);
    ...
    test('should get versions for French language', () async {
      ...
      expect(versions, isNotEmpty);
      expect(versions.any((v) => v.name == 'Louis Segond 1910 (LSG1910)'), isTrue);
